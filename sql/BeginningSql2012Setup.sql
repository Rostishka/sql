...
USE [master]
GO
ALTER DATABASE Demo MODIFY FILE ( NAME = N'Demo', SIZE = 5000MB )
GO
ALTER DATABASE Demo MODIFY FILE ( NAME = N'Demo_log', SIZE = 1000MB )
GO
...
INSERT INTO dbo.Contestant VALUES('Michaels','Sara','12/10/1978','5''9"', 'WA')
INSERT INTO dbo.Contestant VALUES('Brennon','Tulu','3/21/1979','5''9"','OR')
INSERT INTO dbo.Contestant VALUES('Tilton','Sara','8/7/1980','5''11"','ID')
INSERT INTO dbo.Contestant VALUES('Michaels','Debbie','10/9/1979','5''10"','AK')
INSERT INTO dbo.Contestant VALUES('Brook','Kelly','1/18/1980','5''9"','MI')
INSERT INTO dbo.Contestant VALUES('White','Tara','4/28/1980','5''7"','MO')
INSERT INTO dbo.Contestant VALUES('Larson','Jonnie','2/25/1981','5''9"','NV')
INSERT INTO dbo.Contestant VALUES('White','Susie','11/16/1980','5''8"','AZ')
INSERT INTO dbo.Contestant VALUES('Sharma','Neetie','6/30/1979','5''9"','CA')
GO
...
IF EXISTS (SELECT * FROM sys.tables where [name] = 'ShoppingList')
...
INSERT INTO dbo.PurchaseActivity VALUES('12/8/01','747-400',175000000,1004)
INSERT INTO dbo.PurchaseActivity VALUES('1/16/02','777',120000000,1001)
INSERT INTO dbo.PurchaseActivity VALUES('2/24/02','777',120000000,1002)
INSERT INTO dbo.PurchaseActivity VALUES('4/4/02','747-400',175000000,1004)
INSERT INTO dbo.PurchaseActivity VALUES('5/13/02','767',105000000,1004)
INSERT INTO dbo.PurchaseActivity VALUES('6/21/02','727-200',90000000,1003)
INSERT INTO dbo.PurchaseActivity VALUES('7/30/02','747-400',175000000,1005)
INSERT INTO dbo.PurchaseActivity VALUES('9/7/02','747-400',175000000,1001)
INSERT INTO dbo.PurchaseActivity VALUES('10/16/02','767',105000000,1005)
INSERT INTO dbo.PurchaseActivity VALUES('11/24/02','727-200',90000000,1002)
INSERT INTO dbo.PurchaseActivity VALUES('12/8/02','747-400',175000000,1004)
GO
...
CREATE PROC Lab61SelfChecker
AS
BEGIN


DELETE dbtester.dbo.TestScore
...
BEGIN
	...
	IF EXISTS(SELECT * FROM JProCo.Sys.Tables WHERE name = 'Customer')
	BEGIN
		INSERT INTO dbTester.dbo.TestScore
		SELECT 'Customer found' as item, 100 as pts

			IF EXISTS (SELECT * FROM JProCo.sys.columns WHERE [name] = 'CustomerID')
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'CustomerID field Found' as item, 100 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'CustomerID field NOT Found' as item, 0 as pts
			END



			IF EXISTS (SELECT * FROM JProCo.sys.columns WHERE [name] = 'CustomerType')
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'CustomerType field Found' as item, 100 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'CustomerType field NOT Found' as item, 0 as pts
			END


			IF EXISTS (SELECT * FROM JProCo.sys.columns SC
						INNER JOIN JProCo.Sys.tables ST
						ON SC.Object_ID = ST.Object_id
						WHERE SC.[name] = 'FirstName'
						AND ST.[Name] = 'Customer')
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'FirstName field Found' as item, 100 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'FirstName field NOT Found' as item, 0 as pts
			END
			...
			IF EXISTS (SELECT * FROM JProCo.sys.columns SC
						INNER JOIN JProCo.Sys.tables ST
						ON SC.Object_ID = ST.Object_id
						WHERE SC.[name] = 'LastName'
						AND ST.[Name] = 'Customer')
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'LastName field Found' as item, 100 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'LastName field NOT Found' as item, 0 as pts
			END
			...
			IF EXISTS (SELECT * FROM JProCo.sys.columns SC
						INNER JOIN JProCo.Sys.tables ST
						ON SC.Object_ID = ST.Object_id
						WHERE SC.[name] = 'CompanyName'
						AND ST.[Name] = 'Customer')
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'CompanyName field Found' as item, 100 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'CompanyName field NOT Found' as item, 0 as pts
			END

			IF ((SELECT Count(*) FROM JProCo.dbo.Customer)=5)
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Populated correctly' as item, 100 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Not Populated correctly' as item, 0 as pts
			END




			IF ((SELECT Count(*) FROM JProCo.dbo.Customer WHERE FirstName = 'Mark')=1)
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Mark is found' as item, 50 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Mark is found' as item, 0 as pts
			END



			IF ((SELECT Count(*) FROM JProCo.dbo.Customer WHERE FirstName = 'Lee')=1)
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Lee is found' as item, 50 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Lee is found' as item, 0 as pts
			END


			IF ((SELECT Count(*) FROM JProCo.dbo.Customer WHERE FirstName = 'Patricia')=1)
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Patricia is found' as item, 50 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Patricia is found' as item, 0 as pts
			END


			IF ((SELECT Count(*) FROM JProCo.dbo.Customer WHERE FirstName = 'Mary')=1)
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Mary is found' as item, 50 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Mary is found' as item, 0 as pts
			END


			IF ((SELECT Count(*) FROM JProCo.dbo.Customer WHERE CompanyName = 'MoreTechnology.com')=1)
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer MoreTechnology.com is found' as item, 50 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer MoreTechnology.com is NOT found' as item, 0 as pts
			END


			IF ((SELECT Count(*) FROM JProCo.dbo.Customer WHERE FirstName IS NULL AND CustomerID = 5)=1)
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Null in record 5 is found' as item, 50 as pts
			END
			ELSE
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Null in record 5 is NOT found' as item, 0 as pts
			END
	...
	BEGIN 
		INSERT INTO dbTester.dbo.TestScore
		SELECT 'Customer not found' as item, 0 as pts
	END

END
END TRY
BEGIN CATCH
	PRINT 'The JProCo database must exists on this SQL instance to do this lab'
END CATCH

	

SELECT * FROM dbtester.dbo.TestScore
SELECT SUM(pts) FROM dbtester.dbo.TestScore as TotalScore
